...
export class CalendarMonthViewComponent
  ...
  @Output()
  addImageBackground: EventEmitter<any> = new EventEmitter();

  @Output()
  createEvent: EventEmitter<any> = new EventEmitter();
  ...
  addBgImage(day) {
    this.addImageBackground.emit(day);
  }

  createNewEvent(day) {
    this.createEvent.emit(day);
  }
}
